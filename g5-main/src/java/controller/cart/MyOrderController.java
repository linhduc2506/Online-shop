...
public class MyOrderController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Order> orderNum = OrderDAO.getOrderByUserid((int) a);
        request.setAttribute("OrderList",orderNum);
        
        List<Product> productList = OrderDAO.getProductByBuyerId((int) a);
        request.setAttribute("ProductList", productList);
        
        List<OrderProduct> orderQuantity = OrderDAO.getOrderProductByBuyerId((int) a);
