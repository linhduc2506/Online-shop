...
public class MyOrderController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Order> orderNum = OrderDAO.getOrderByUserid(2);
        request.setAttribute("OrderList",orderNum);
        
        List<Product> productList = OrderDAO.getProductByBuyerId(2);
        request.setAttribute("ProductList", productList);
        
        List<OrderProduct> orderQuantity = OrderDAO.getOrderProductByBuyerId(2);
