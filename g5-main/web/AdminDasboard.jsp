<%-- 
    ...
    Created on : Mar 1, 2022, 11:23:41 AM
    Author     : LAPTOP D&N
--%>
...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <!-- bootstrap 3.0.2 -->
        <link href="contents/css2/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <!-- font Awesome -->
        <link href="contents/css2/font-awesome.min.css" rel="stylesheet" type="text/css" />
        <!-- Ionicons -->
        <link href="contents/css2/ionicons.min.css" rel="stylesheet" type="text/css" />
        <!-- google font -->
        <link href='http://fonts.googleapis.com/css?family=Lato' rel='stylesheet' type='text/css'>
        <!-- Theme style -->
        <link href="contents/css2/style.css" rel="stylesheet" type="text/css" />
    ...
    <body class="skin-black">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        <li><!-- start message -->
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="contents/images/admin/26115.jpg" class="img-circle" alt="User Image"/>
                                                </div>
                                                <h4>
                                                    Support Team
                                                </h4>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="contents/images/admin/avatar.png" class="img-circle" alt="user image"/>
                                                </div>
                                                <h4>
                                                    Developers
                                    ...
                                    <ul class="media-list">
                                        <li class="media">
                                            <a href="#" class="pull-left">
                                                <img src="contents/images/admin/26115.jpg" alt="Avatar" class="img-circle" width="64" height="64">
                                            </a>
                            ...
                            <div class="panel">
                                ...
                                <ul class="list-group teammates">
                                    <li class="list-group-item">
                                        <a href=""><img src="contents/images/admin/26115.jpg" width="50" height="50"></a>
        ...
        <!-- jQuery UI 1.10.3 -->
        <script src="contents/js2/jquery-ui-1.10.3.min.js" type="text/javascript"></script>
        <!-- Bootstrap -->
        <script src="js/bootstrap.min.js" type="text/javascript"></script>
        <!-- daterangepicker -->
        <script src="contents/js2/plugins/daterangepicker/daterangepicker.js" type="text/javascript"></script>

        <script src="contents/js2/plugins/chart.js" type="text/javascript"></script>
        ...
        <!-- iCheck -->
        <script src="contents/js2/plugins/iCheck/icheck.min.js" type="text/javascript"></script>
        <!-- calendar -->
        <script src="contents/js2/plugins/fullcalendar/fullcalendar.js" type="text/javascript"></script>

        <!-- Director App -->
        <script src="contents/js2/Director/app.js" type="text/javascript"></script>

        <!-- Director dashboard demo (This is only for demo purposes) -->
        <script src="contents/js2/Director/dashboard.js" type="text/javascript"></script>
