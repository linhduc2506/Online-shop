<%-- 
    Document   : Cart
    Created on : Jan 31, 2022, 6:36:01 PM
    Author     : LAPTOP D&N
--%>
            ...
            <div class="container">
                ...
                <div class="table-responsive cart_info">
                    <table class="table table-condensed">
                        ...
                        <tbody>
                            <c:set var="t" value="0"/>
                            <c:forEach items="${o.carts}" var="i">
                                <tr>
                                    <td class="cart_product">
                                        <a href=""><img src="${i.product.thumbnail}" alt=""></a>
                                    </td>
                                    ...
                                    <td class="cart_quantity">
                                        <div class="cart_quantity_button">
                                            <a class="cart_quantity_down" href="cart?num=-1&id=${i.product.id}"> - </a>
                                            <input class="cart_quantity_input" type="text" name="quantity" value="${i.quantity}">
                                            <a class="cart_quantity_up" href="cart?num=1&id=${i.product.id}"> + </a>
                                        </div>
                                    </td>
                                    <td class="cart_total">
                                        <p class="cart_total_price"><fmt:formatNumber pattern="##.#" value="${i.quantity*i.product.price}"/></p>
                                    </td>
                                    <td class="cart_delete">
                                        <a class="cart_quantity_delete" href=""><i class="fa fa-times"></i></a>
                                    </td>
                                </tr>
                                <c:set var="t" value="${t+i.quantity*i.product.price}"/>
                            </c:forEach>
                        </tbody>
                    </table>
                </div>
