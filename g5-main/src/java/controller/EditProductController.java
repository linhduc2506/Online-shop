...
public class EditProductController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            listProductCategory = ProductCategoryDAO.allCategory();
        } catch (SQLException ex) {
            Logger.getLogger(EditProductController.class.getName()).log(Level.SEVERE, null, ex);
        }
        user2 = UserDAO.findById(product.getCreatorId());
        

        request.setAttribute("listC", listProductCategory);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ProductDAO.editProduct(name, quantity, price, category, thumbnail, description, id);
        } catch (SQLException ex) {
            Logger.getLogger(EditProductController.class.getName()).log(Level.SEVERE, null, ex);
        }
