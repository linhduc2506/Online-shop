<%-- 
    ...
    Created on : Sep 30, 2021, 10:56:01 AM
    Author     : asus
--%>       
...
<html lang="en">
    ...
    <body class="signup-form" >
        ...
        <!--end of menu-->
        <div >
            <form action="ForgotPasswordController" method="POST" class="form-horizontal" style="color: black">
                <div class="row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <input type="text" class="form-control" name="email" required="required" style="border-color: black">
                    </div>        	
                </div>
